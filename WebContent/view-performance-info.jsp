<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="java.util.List,tum.in.dbpra.bean.TimeSlotBeanProvider"%>
<!DOCTYPE html>
...
<body>
	...
	<div class="container">
		...
		<div class="codrops-top">
			...
			<span class="right"> <!-- <a href="checkout-provider.jsp"> -->
			...
			<div id="container_demo">
				...
				<div id="wrapper">
					<div id="login" class="animate form">
						...
						<form>
							<%
								List<TimeSlotBeanProvider> timeslots = (List<TimeSlotBeanProvider>) request
										.getAttribute("timeslots");
							%>

							<%
								for (int i = 0; i < timeslots.size(); i++) {
							%>
							<strong>Time Slot N <%=i + 1%>:
							</strong><br> <strong>Time to be on stage: </strong>
							<%=timeslots.get(i).getTimebuildup()%>
							<br> <strong>Time to start performance: </strong>
							<%=timeslots.get(i).getTimeplay()%>
							<br> <strong>Time to finish performance: </strong>
							<%=timeslots.get(i).getTimefinish()%>
							<br> <strong>Time to leave stage: </strong>
